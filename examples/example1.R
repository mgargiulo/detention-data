...
inadmissible_aliens = read.csv("yrbk_2017_enf_excel_final/fy2017_table38.csv", stringsAsFactors = FALSE)
granted_asylum = read.csv("YRBK 2017 RFA Excel Final/fy2017_table16.csv", stringsAsFactors = FALSE)
...
combined$Total_asylees = gsub(",", "", combined$Total_asylees)
combined$Total_asylees = as.numeric(combined$Total_asylees)
combined$Total_inadmissible = gsub(",", "", combined$Total_inadmissible)
